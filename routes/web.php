...
Route::get('/masjid/{id}/edit','MasjidController@edit')->middleware('auth')->name('masjid.edit');
Route::put('/masjid/{id}','MasjidController@update')->middleware('auth')->name('masjid.update');
